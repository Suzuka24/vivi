...
- Open PNG, JPEG, TIFF, FITS, and other supported image formats. TIFF stacks, hyperstacks, and multi-HDU FITS files expose their slices or series. Import an image folder as a naturally sorted stack, choosing either 2D images only or every plane of 2D and 3D images; slices retain their source filenames and plane numbers. Basic AVI/MP4/MOV/MKV previews are also supported when a suitable codec is available.
